 	...
 	<div class="generic-container">
		...
		<div class="well lead">Форма регистрации пользователя</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="userProfiles">Роль</label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-actions floatRight">
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Обновить" class="btn btn-primary btn-sm"/> или <a href="<c:url value='/list' />">Отмена</a>
						</c:when>
						<c:otherwise>
							<input type="submit" value="Регистрация" class="btn btn-primary btn-sm"/> или <a href="<c:url value='/list' />">Отмена</a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
